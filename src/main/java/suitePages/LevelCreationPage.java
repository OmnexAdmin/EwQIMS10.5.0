...
public class LevelCreationPage extends ProjectMethods {
	...
	public LevelCreationPage createSubLevels(String searchCriteria, String levelName, String subLevelName,
			String subPrefix, String subReviewDue) throws Throwable {
	...
	public LevelCreationPage editLevels(String searchCriteria, String levelName, String editedLevelName,
			String editedPrefix, String editedReviewDue) throws Throwable {
